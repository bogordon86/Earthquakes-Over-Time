...
renderMap(earthquakesURL, platesURL);

function renderMap(earthquakesURL, platesURL) {
...
//into the createFeatures function
    ...
    function createFeatures(earthquakeData, platesData) {
        ...
        function forEachQuakeLayer(feature, layer) {
            return new L.circleMarker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
                fillOpacity: 1,
                color: "black",
                weight: 0.75,
                fillColor: pickColors(feature.properties.mag),
                radius:  markerSize(feature.properties.mag)
            });
        }
        function forEachEarthquake(feature, layer) {
            layer.bindPopup("<h3>Magnitude: " + feature.properties.mag + "</h3><hr><h4>Place: " + feature.properties.place + "</h4><hr><p>" + new Date(feature.properties.time) + "</p>");
        };
        ...
        // Converts the tectonic plates data array to geoJSON object and styles each element
        var plates = L.geoJSON(platesData, {
            onEachFeature: forEachPlate,
            style: {
                weight: 2,
                color: 'orange'
            }
